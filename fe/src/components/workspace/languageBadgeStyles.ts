...
const LANGUAGE_BADGE: Record<string, string> = {
  ...
  gold: "border-amber-500/35 bg-amber-500/10 text-amber-800 dark:text-amber-300",
  geekblue: "border-indigo-500/35 bg-indigo-500/10 text-indigo-700 dark:text-indigo-300",
  cyan: "border-cyan-500/35 bg-cyan-500/10 text-cyan-800 dark:text-cyan-300",
  green: "border-emerald-500/35 bg-emerald-500/10 text-emerald-700 dark:text-emerald-300",
  purple: "border-purple-500/35 bg-purple-500/10 text-purple-700 dark:text-purple-300",
  volcano: "border-orange-500/35 bg-orange-500/10 text-orange-700 dark:text-orange-300",
  ...
  default: "border-slate-500/35 bg-slate-500/10 text-slate-600 dark:text-slate-300",
};
