...
# Run after pull-runner-images.sh on Coolify (or any host that pulls ghcr.io/.../code-challenge-ide-*).
set -euo pipefail
...
declare -a PAIRS=(
  "runner-java-25:code-challenge-ide-runner-java-25:local"
  "runner-java-26:code-challenge-ide-runner-java-26:local"
  "runner-python-312:code-challenge-ide-runner-python-312:local"
  "runner-go-123:code-challenge-ide-runner-go-123:local"
  "runner-node-22:code-challenge-ide-runner-node-22:local"
  "runner-dotnet-8:code-challenge-ide-runner-dotnet-8:local"
  "runner-typescript-57:code-challenge-ide-runner-typescript-57:local"
  "runner-rust-184:code-challenge-ide-runner-rust-184:local"
  "runner-cpp-20:code-challenge-ide-runner-cpp-20:local"
