...
WARM_TARGETS: tuple[WarmTarget, ...] = (
    ...
    WarmTarget("java", "java", "LSP_JAVA_IMAGE", "code-challenge-ide-pro-lsp-java:local", 180),
    WarmTarget("python", "python", "LSP_PYTHON_IMAGE", "code-challenge-ide-pro-lsp-python:local", 30),
    WarmTarget(
        "go",
        "go",
        "LSP_GO_IMAGE",
        "code-challenge-ide-pro-lsp-go:local",
        20,
        smoke=True,
        smoke_entrypoint="gopls",
        smoke_args=("version",),
    ),
    WarmTarget("typescript", "typescript", "LSP_TYPESCRIPT_IMAGE", "code-challenge-ide-pro-lsp-typescript:local", 45),
    WarmTarget(
        "csharp",
        "csharp",
        "LSP_DOTNET_IMAGE",
        "code-challenge-ide-pro-lsp-dotnet:local",
        20,
        smoke=True,
    ...
    WarmTarget(
        ...
        "rust",
        "LSP_RUST_IMAGE",
        "code-challenge-ide-pro-lsp-rust:local",
        20,
        smoke=True,
    ...
    WarmTarget(
        ...
        "cpp",
        "LSP_CPP_IMAGE",
        "code-challenge-ide-pro-lsp-cpp:local",
        20,
        smoke=True,
