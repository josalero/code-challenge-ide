...
SET docker_image = 'code-challenge-ide-runner-go-123:local',
    active = TRUE
WHERE id = '00000000-0000-0000-0000-000000005123';

UPDATE language_runtimes
SET docker_image = 'code-challenge-ide-runner-node-22:local',
    active = TRUE
...
VALUES (
    ...
    '8.0',
    'code-challenge-ide-runner-dotnet-8:local',
    FALSE
)
